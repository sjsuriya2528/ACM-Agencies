...
const Profile = () => {
    ...
    const handleSendOTP = async () => {
        ...
        setLoading(true);
        try {
            await axios.post('/auth/send-password-otp');
    ...
    const handleVerifyOTP = async () => {
        ...
        setLoading(true);
        try {
            await axios.post('/auth/verify-password-otp', { otpCode });
    ...
    const handleUpdatePassword = async () => {
        ...
        setLoading(true);
        try {
            await axios.post('/auth/update-password', { newPassword });
                        ...
                        {step === 'send_otp' && (
                            <div className="text-center space-y-6 py-4">
                                <div className="p-4 bg-amber-50 dark:bg-amber-900/20 rounded-2xl border border-amber-100 dark:border-amber-900/30 text-amber-800 dark:text-amber-400 text-sm inline-block mx-auto mb-4">
                                    ...
                                    <p className="opacity-80">We'll send an OTP to your email for security.</p>
                                </div>
