...
const { recordPayment, getPayments, approvePayment, rejectPayment, cancelPayment, bulkApprovePayments, getPaymentReceipt } = require('../controllers/paymentController');
